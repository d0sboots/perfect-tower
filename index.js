...
function settingsLoad() {
    let settingsVal = {};
    if (storageEnabled) {
        settingsVal = JSON.parse(localStorage.getItem("settings") ?? "{}");
...
function doneLoading() {
    ...
    updateWarn(true);
    scriptLoad();
    workspaceLoad(settings.workspaceList);
    // Re-write settings values *after* we have populated the workspaces
    settingsChange();
